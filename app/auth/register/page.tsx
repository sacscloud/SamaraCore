            ...
            {[
              {
                icon: "🚀",
                title: "Setup Rápido", 
                desc: "Crea tu primer agente en minutos"
              },
              {
                icon: "🔒",
                title: "100% Seguro",
              ...
              },
              {
                icon: "💡",
                title: "Sin Límites",
                desc: "Construye tantos agentes como necesites"
              }
            ].map((benefit, index) => (
              <div key={index} className="flex items-center gap-3 p-3 bg-gray-900/20 rounded-lg border border-gray-700/30">

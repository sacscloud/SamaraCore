        ...
        <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card className="bg-gray-50 dark:bg-gray-900/40 border-gray-200 dark:border-gray-700/50">
              <CardHeader>
                <CardTitle className="text-gray-900 dark:text-white">Información Básica</CardTitle>
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label htmlFor="agentName" className="text-gray-900 dark:text-white">Nombre del Agente</Label>
                  <Input
                    id="agentName"
                ...
                <div>
                  <Label htmlFor="description" className="text-gray-900 dark:text-white">Descripción (Opcional)</Label>
                  <Textarea
                    id="description"
            ...
            <div className="flex gap-4 justify-end">
              <Link href="/dashboard">
                <Button 
                  type="button" 
                  variant="outline" 
                  className="border-gray-300 dark:border-gray-600/50 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800/50"
                >
                  Cancelar
                </Button>
              </Link>

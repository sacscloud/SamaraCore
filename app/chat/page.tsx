...
function ChatPageContent() {
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-white dark:bg-gray-900">
        <div className="text-center">
          ...
          <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Agente no especificado</h1>
          <p className="text-gray-600 dark:text-gray-300 mb-4">No se ha especificado qué agente usar para el chat</p>
          <button 
        ...
        <div className="text-center">
          {agentError ? (
            <>
              ...
              <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Error cargando agente</h1>
              <p className="text-gray-600 dark:text-gray-300 mb-2">No se pudo cargar el agente especificado</p>
            ...
            <>
              ...
              <p className="text-gray-600 dark:text-gray-300">Cargando agente...</p>
                              <p className="text-sm text-gray-600 dark:text-gray-500 mt-2">ID: {agentId}</p>
            </>
          )}
        </div>
      </div>
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-gray-900">
      {/* Sidebar */}
              <div className={`${sidebarOpen ? 'w-80' : 'w-0'} transition-all duration-300 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 relative`} 
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="p-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded text-gray-500 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
            >
          ...
          <button
            ...
            className="w-full flex items-center gap-2 p-2 text-left hover:bg-blue-50 dark:hover:bg-gray-700 rounded-lg mb-2 text-blue-600 dark:text-gray-300 hover:text-blue-700 dark:hover:text-white border border-blue-200 dark:border-gray-600"
          >
            ...
            <div className="flex items-center gap-2">
              {currentConversation && (
                <>
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg ${currentConversation.shared ? 'bg-blue-600 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white'}`}
              ...
              <div className="relative user-menu-container">
                <button
                  ...
                  className="w-10 h-10 rounded-full overflow-hidden border-2 border-gray-300 dark:border-gray-600 hover:border-gray-400 transition-colors bg-gradient-to-br from-blue-500 to-purple-600"
                >
                ...
                {showUserMenu && (
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg z-50 py-2">
                    ...
                    <div className="py-1">
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white flex items-center gap-2"
                      >
          ...
          <div className="flex items-start gap-2">
            <div className="flex-1 relative">
              <textarea
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none min-h-[44px] max-h-32 disabled:bg-gray-100 dark:disabled:bg-gray-700 disabled:text-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
      ...
      {shareModal.show && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
            <div className="flex items-center justify-between mb-4">
                              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">¡Conversación compartida!</h3>
              <button
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded border border-gray-300 dark:border-gray-600 mb-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={async () => {
                    ...
                    // Mostrar feedback visual de copiado
                                      ...
                                      className="ml-2 p-1 hover:bg-gray-200 dark:hover:bg-gray-600 rounded text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
                  title="Copiar enlace"
                >
...
function ConversationItem({ 
  ...
  return (
    <div className={`group relative p-3 rounded-lg cursor-pointer ${isActive ? 'bg-blue-100 dark:bg-blue-600/20 border border-blue-300 dark:border-blue-500/30' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
      <div onClick={onClick} className="flex-1">
        {isEditing ? (
          ...
          <div className="text-sm font-medium truncate text-gray-900 dark:text-white">{conversation.title}</div>
        )}
      ...
      <button
        ...
        className="absolute top-2 right-2 p-1 opacity-0 group-hover:opacity-100 hover:bg-gray-200 dark:hover:bg-gray-600 rounded text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
      >
      ...
      {showMenu && (
        <div 
          className="fixed bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg z-50 py-1 min-w-[160px]"
          style={{
        ...
        >
          <button
            ...
            className="w-full px-3 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-gray-600 flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
          >
          ...
          <button
            ...
            className="w-full px-3 py-2 text-left text-sm hover:bg-red-50 dark:hover:bg-gray-600 text-red-500 dark:text-red-400 hover:text-red-600 dark:hover:text-red-300 flex items-center gap-2"
          >
...
function MessageBubble({ 
  ...
  return (
    ...
    >
      <div className={`max-w-[80%] ${message.role === 'user' ? 'bg-blue-500 text-white' : 'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white'} rounded-lg p-4 relative group`}>
        {/* Nombre del remitente */}
        <div className={`text-xs font-medium mb-2 ${message.role === 'user' ? 'text-blue-100' : 'text-gray-500 dark:text-gray-300'}`}>
        ...
        {showActions && (
          <div className="absolute -top-8 right-0 flex items-center gap-1 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg shadow-lg p-1">
            <button
              onClick={handleCopy}
              className="p-1 hover:bg-gray-100 dark:hover:bg-gray-600 rounded text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
              title="Copiar"
            >
